...
I checked the quality of the data by running the script [Multi_FASTQC.sh](https://github.com/philippinespire/pire_fq_gz_processing/blob/main/Multi_FASTQC.sh).  The instructions are unclear here.
