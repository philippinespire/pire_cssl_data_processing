...
BAMPATTERN=*-merged.ssl.Ssp-3NR-R1R2ORPH-contam-noisolate-RG.bam

SCRIPTPATH=$( cd "$(dirname "${BASH_SOURCE[0]}")" ; pwd -P )

all_samples=$(ls $BAMDIR/$BAMPATTERN | sed -e 's/-merged\.ssl\.Ssp-3NR-R1R2ORPH-contam-noisolate-RG\.bam//' -e 's/.*\///g')
