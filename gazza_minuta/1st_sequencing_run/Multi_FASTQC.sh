...
crun multiqc . -n ./multiqc_postrepair_bam.html

# move fastqc files to new subdirectory
#ls *fastqc.html | parallel "mv {} /home/r3clark/PIRE/pire_cssl_data_processing/gazza_minuta/Multi_FASTQC" &&
#ls *fastqc.zip | parallel "mv {} /home/r3clark/PIRE/pire_cssl_data_processing/gazza_minuta/Multi_FASTQC"
