...
fltrVCF Settings, run fltrVCF -h for description of settings
	...
	#fltrVCF -f 01 02 03 04 14 07 05 16 15 06 11 09 10 04 13 05 16 07 18                  # order to run filters in
	fltrVCF -f 14 07 05 16 15 06 11 09 10 04 13 05 16 07 18                  # order to run filters in
	...
	fltrVCF -d ../mkBAM/mapped.ssl.Lle-C-3NR-R1R2ORPH-contam-noisolate-off.bed           # bed file used in genotyping
	#fltrVCF -v ../mkBAM/TotalRawSNPs.ssl.Lle-C-3NR-R1R2ORPH-contam-noisolate-off.vcf     # vcf file to filter
	fltrVCF -v lle.A.ssl.Lle-C-3NR-R1R2ORPH-contam-noisolate-off.Fltr04.4.recode.vcf     # vcf file to filter
        fltrVCF -g ../mkBAM/reference.ssl.Lle-C-3NR-R1R2ORPH-contam-noisolate-off.fasta      # reference genome
	fltrVCF -p ../mkBAM/popmap.denovoSSL.Aur-C_500_R1R2ORPHMRGD_decontam_noisolate       # popmap file
	...
	fltrVCF -o lle.B                                                                     # prefix on output files, use to track settings
...
Filters
	# See manual for how to pass multiple settings to filters that are run multiple times
        ...
        05 vcftools --max-missing       0.55:0.8        #Remove sites with at least 1 - value missing data (1 = no missing data) [0.5]
        ...
        13 vcftools --max-meanDP        200             #Remove sites with higher mean depth [250]
        ...
        16 vcftools --missing-indv      0.5:0.2         #Remove individuals with more missing data. [0.5]
