...
fltrVCF Settings, run fltrVCF -h for description of settings
	...
	fltrVCF -f 18                  # order to run filters in
	...
	fltrVCF -v lle.B.ssl.Lle-C-3NR-R1R2ORPH-contam-noisolate-off.Fltr07.14.vcf           # vcf file to filter
        fltrVCF -g ../mkBAM/reference.ssl.Lle-C-3NR-R1R2ORPH-contam-noisolate-off.fasta      # reference genome
	fltrVCF -p ../mkBAM/popmap.ssl.Lle-C-3NR-R1R2ORPH-contam-noisolate-off               # popmap file
	...
	fltrVCF -o lle.C                                                                     # prefix on output files, use to track settings
