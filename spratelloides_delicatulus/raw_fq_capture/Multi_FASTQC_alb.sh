...
#SBATCH --job-name=albMulti_fastqc
...
#grep -vf filesdone allfiles | xargs ls | parallel -kj40 "crun fastqc {}" &&
grep -vf albdonefiles alballfiles | xargs ls | parallel -kj4 "crun fastqc {}"
...
#ls *fastqc.html | parallel -kj 40 "mv {} ../Multi_FASTQC" &&
