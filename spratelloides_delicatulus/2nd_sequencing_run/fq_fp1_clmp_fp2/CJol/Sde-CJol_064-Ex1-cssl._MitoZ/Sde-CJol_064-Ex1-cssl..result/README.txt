...
File:
errorsummary.val
Sde-CJol_064-Ex1-cssl._mitoscaf.fa.val
...
File:
Sde-CJol_064-Ex1-cssl._mitoscaf.fa.gbf

- 4. The mitochondrial genome in Fasta format.
File:
Sde-CJol_064-Ex1-cssl..fasta
...
the file Sde-CJol_064-Ex1-cssl._mitoscaf.fa.gbf has no annotation problem.
File:
Sde-CJol_064-Ex1-cssl._mitoscaf.fa.sqn

- 7. The feature table for the mitochondrial genome.
File:
Sde-CJol_064-Ex1-cssl._mitoscaf.fa.tbl
