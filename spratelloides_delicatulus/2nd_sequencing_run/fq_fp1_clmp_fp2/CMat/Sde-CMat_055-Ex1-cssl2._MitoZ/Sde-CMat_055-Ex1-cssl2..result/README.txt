...
File:
errorsummary.val
Sde-CMat_055-Ex1-cssl2._mitoscaf.fa.val
...
File:
Sde-CMat_055-Ex1-cssl2._mitoscaf.fa.gbf

- 4. The mitochondrial genome in Fasta format.
File:
Sde-CMat_055-Ex1-cssl2..fasta
...
- 6. The mitochondrial genome in sqn format.
This file can be used to upload to GenBank database after you confirm
the file Sde-CMat_055-Ex1-cssl2._mitoscaf.fa.gbf has no annotation problem.
File:
Sde-CMat_055-Ex1-cssl2._mitoscaf.fa.sqn

- 7. The feature table for the mitochondrial genome.
File:
Sde-CMat_055-Ex1-cssl2._mitoscaf.fa.tbl

------------------------------------------------------------------------------------------
------------------------- each gene sequences --------------------------------------------

- 8. The CDS sequences of each protein coding gene.
File:
Sde-CMat_055-Ex1-cssl2..cds

- 9. The rRNA gene sequences for each rRNA gene.
File:
Sde-CMat_055-Ex1-cssl2..rrna

- 10. The tRNA gene sequences for each tRNA gene.
File:
Sde-CMat_055-Ex1-cssl2..trna

- 11. The control region sequence.
File:
Sde-CMat_055-Ex1-cssl2..misc_feature

------------------------------------------------------------------------------------------
------------------------- mitochondrial sequences from each kmer assembly ----------------

- 12. The mitochondrial sequences from each Kmer assembly.
File:
work71.mitogenome.fa
        
- 13. The most closely related species of each sequence of each Kmer assembly.
File:
...
- 14. The fasta files of potential contamination or numts,
