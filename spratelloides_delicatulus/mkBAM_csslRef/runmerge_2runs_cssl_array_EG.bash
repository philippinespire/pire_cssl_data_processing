...
ls -1 ${speciesdir}/${speciescode}*RG.bam | xargs -n1 basename | cut -c 1-12 > ${speciesdir}/mergebams_run1run2/1strun_samps 
ls -1 ${speciesdir}/../2nd_sequencing_run/mkBAM_csslRef/${speciescode}*RG.bam | xargs -n1 basename | cut -c 1-12 > ${speciesdir}/mergebams_run1run2/2ndrun_samps 
