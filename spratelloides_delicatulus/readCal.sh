...
#ls ${RAWDIR}/*.fq.gz | parallel --no-notice -kj${PARALLELISM} "echo -n {}'	' && zgrep '^@' {} | wc -l" > ${SPDIR}/preprocess_read_change/raw.temp
#ls ${SPDIR}/fq_fp1/*.fq.gz | parallel --no-notice -kj${PARALLELISM} "zgrep '^@' {} | wc -l" > ${SPDIR}/preprocess_read_change/fp1.temp
#ls ${SPDIR}/fq_fp1_clmp/*.fq.gz | parallel --no-notice -kj${PARALLELISM} "zgrep '^@' {} | wc -l" > ${SPDIR}/preprocess_read_change/clm.temp
#ls ${SPDIR}/fq_fp1_clmp_fp2/*.fq.gz | parallel --no-notice -kj${PARALLELISM} "zgrep '^@' {} | wc -l" > ${SPDIR}/preprocess_read_change/fp2.temp
...
#ls mkBAM_sslRef/*gz | parallel --no-notice -kj${PARALLELISM} "zgrep '^@' {} | wc -l" > preprocess_read_change/repr.temp


cd preprocess_read_change
