...
fltrVCF Settings, run fltrVCF -h for description of settings
        ...
        fltrVCF -c rad.RAW-6-6                               # cutoffs, ie ref description
        fltrVCF -b /home/r3clark/PIRE/pire_cssl_data_processing/atherinomorus_endrachtensis/mkVCF_monomorphic                                                                  # path to *.bam files
        fltrVCF -R ../../scripts/fltrVCF/scripts                                             # path to fltrVCF R scripts
        fltrVCF -d /home/r3clark/PIRE/pire_cssl_data_processing/atherinomorus_endrachtensis/mkBAM/mapped.rad.RAW-6-6.bed           # bed file used in genotyping
        fltrVCF -v /home/r3clark/PIRE/pire_cssl_data_processing/atherinomorus_endrachtensis/mkBAM/TotalRawSNPs.rad.RAW-6-6.vcf  # vcf file to filter
        fltrVCF -g /home/r3clark/PIRE/pire_cssl_data_processing/atherinomorus_endrachtensis/mkBAM/reference.rad.RAW-6-6.fasta      # reference genome
        fltrVCF -p /home/r3clark/PIRE/pire_cssl_data_processing/atherinomorus_endrachtensis/mkBAM/popmap.rad.RAW-6-6                # popmap file
        ...
        fltrVCF -o Aen.B                                                                     # prefix on output files, use to track settings
...
Filters
        ...
        03 vcftools --minQ              20              #Remove sites with lower QUAL [20]
